              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return GestureDetector(
                    onTap: () {
                      final selectedListTileProvider =
                          Provider.of<SelectedListTileProvider>(context,
                              listen: false);
                      selectedListTileProvider.setSelectedListTile(listItem);
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => DiscoverDetailScreen(
                            image: selectedListTileProvider
                                .selectedListTile!['leading'],
                            title: selectedListTileProvider
                                .selectedListTile!['title'],
                          ),
                        ),
                      );
                    },
