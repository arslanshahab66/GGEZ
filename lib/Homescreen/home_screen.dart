...
import '../Providers/selected_container_provider.dart';
      ...
      child: Scaffold(
        ...
        body: Stack(
          children: [
            ...
            Positioned(
              top: model.isFollowingSelected
                  ? MediaQuery.of(context).size.height * 0.73
                  : MediaQuery.of(context).size.height * 0.73,
              left: model.isFollowingSelected
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    GestureDetector(
                      onTap: () {
                        model.isFollowingSelected = false;
                      },
                      child: Container(
                        height: 40,
                        width: 150,
                        decoration: BoxDecoration(
                          color: model.isFollowingSelected
                              ? Colors.transparent
                    ...
                    GestureDetector(
                      onTap: () {
                        model.isFollowingSelected = true;
                      },
                      child: Container(
                        height: 40,
                        width: 150,
